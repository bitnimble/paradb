...
declare module 'zapatos/schema' {
  ...
  export namespace public {
    ...
    export type Selectable =
      | difficulties.Selectable
      | favorites.Selectable
      | maps.Selectable
      | users.Selectable;
    export type JSONSelectable =
      | difficulties.JSONSelectable
      | favorites.JSONSelectable
      | maps.JSONSelectable
      | users.JSONSelectable;
    export type Whereable =
      | difficulties.Whereable
      | favorites.Whereable
      | maps.Whereable
      | users.Whereable;
    export type Insertable =
      | difficulties.Insertable
      | favorites.Insertable
      | maps.Insertable
      | users.Insertable;
    export type Updatable =
      | difficulties.Updatable
      | favorites.Updatable
      | maps.Updatable
      | users.Updatable;
    export type UniqueIndex =
      | difficulties.UniqueIndex
      | favorites.UniqueIndex
      | maps.UniqueIndex
      | users.UniqueIndex;
